...
# Submit Ticket
with tab1:
    if table_exists('analytics', 'product_catalog'):
        ...
        if st.button("Submit Ticket"):
            ...
            cur = conn.cursor()
            cur.execute("""
                INSERT INTO assets.tickets (product_id, task, priority, status, completed)
        ...
        st.subheader("Ticket Submission will be available after the data pipeline has completed.")
...
with tab2:
    if table_exists('assets', 'tickets') and table_exists('analytics', 'product_catalog'):
        ...
        st.subheader("Ticket Queue will be available after the data pipeline has completed.")
    
# Product Catalog
with tab3:
    if table_exists('raw', 'products') and table_exists('enriched', 'product_enrichments'):
        ...
        st.subheader("Product Catalog will be available after the data pipeline has completed.")
    
# Generated Assets
with tab4:
    if table_exists('assets', 'generated_content') and table_exists('analytics', 'product_catalog'):
        ...
        st.subheader("Generated Assets will be available after the data pipeline has completed.")
...
with tab5:
    if table_exists('assets', 'generated_content') and table_exists('analytics', 'product_catalog'):
        ...
        st.subheader("LLMOps will be available after the data pipeline has completed.")